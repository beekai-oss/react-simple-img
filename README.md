...
| `importance`        | string  |          | Priority Hints with "low" or "high": set to "high" will load image after <b>load</b> event, otherwise "low" will load images after <b>load</b> event and lazy load with <b>intersection observer</b>                                  |
